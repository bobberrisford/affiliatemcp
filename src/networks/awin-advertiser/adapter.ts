...
const META: NetworkMeta = {
  ...
  knownLimitations: [
    ...
    'Verified live on 2026-07-01 against the Awin UK demo account (dummy data), not a real revenue account: listBrands, listTransactions, listMediaPartners returned data; getProgrammePerformance returned rows but its column mapping is not field-verified (stays experimental at operation level).',
    'On the demo, listMediaPartners returned one joined partner while getProgrammePerformance covered several publishers; roster under-return vs a genuinely small roster is unconfirmed (// TODO(verify)).',
    'listTransactions returns the full set with no cursor; wide windows can return tens of thousands of rows (86,772 over 30 days on the demo).',
  ],
