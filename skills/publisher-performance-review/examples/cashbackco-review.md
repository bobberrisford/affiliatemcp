...
so the default window is 2026-03-17 to 2026-06-15 (90 days).

**User**: Review CashbackCo for Acme, I've got a call with them tomorrow.

**Assistant**: Pulling CashbackCo's last 90 days on Acme (2026-03-17 to 2026-06-15) against the prior 90 days (2025-12-17 to 2026-03-16)...
...
Called:
- `affiliate_awin-advertiser_get_programme_performance({ brand: "acme", from: "2026-03-17", to: "2026-06-15", publisherId: "557001" })`
...
Status: active. Current window 2026-03-17 to 2026-06-15 (90 days); comparison 2025-12-17 to 2026-03-16 (90 days).
...
- Apr 2026: £58,200
- May 2026: £61,400
- Jun 2026 (to date): £52,200 — on pace to beat May.

### Talking points

- Revenue up 14% over the quarter; CashbackCo remains the top partner on Acme.
- AOV climbed £1.18 while conversion rate dipped slightly — they are sending higher-value, slightly less frequent buyers.
- EPC is flat at £0.93; a tenancy or featured-placement test could lift volume without changing the rate.
- Reversals are stable and low; no quality concern to raise.

---

For every publisher at once, use `programme-performance-report`. For the weekly
client summary, use `programme-weekly-report`.
